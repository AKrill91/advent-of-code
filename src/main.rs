...
fn main() {
    ...
    if days_to_run.contains(&17) {
        info!("Starting day17");
        let input = advent_helper::read_file_lines("resources/2020/day17.txt");

        info!("day17::run_a = {}", day17::run_a(&input));
        info!("day17::run_b = {}", day17::run_b(&input));
    }

    if days_to_run.contains(&18) {
        info!("Starting day18");
        let input = advent_helper::read_file_lines("resources/2020/day18.txt");
    ...
    if days_to_run.contains(&20) {
        info!("Starting day20");
        let input = advent_helper::read_file_lines("resources/2020/day20.txt");

        info!("day20::run_a = {}", day20::run_a(&input));
        info!("day20::run_b = {}", day20::run_b(&input));
    }
